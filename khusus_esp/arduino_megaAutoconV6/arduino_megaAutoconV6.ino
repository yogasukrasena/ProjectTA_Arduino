...
int UltraRight(){
  ...
  jarak = round(distance); //hasil akhir dibulatkan
...
//    Serial.println("data terkirim ke esp");    
    espSerial.print("espFirebase,"+String(gpsStatus)+","+String(statusFinger)+","+VIn+","+String(buttonValue)+","+String(batteryPercent())+",");
    espSerial.print(String(latVar,6)+","+String(lngVar,6)+",");
    espSerial.println(dataPulse);   
    Serial.println("data terkirim ke esp");    
