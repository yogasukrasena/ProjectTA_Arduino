...
void setLogTime(){
  ...
  char waktu_nama[40], tanggal_nama[40];  
  ...
  sprintf(waktu_nama,"%s/log_data/%s/waktu_mulai",nameDevice,nameLog);
  if(Firebase.RTDB.setString(&fbdo, waktu_nama, currentWaktu)){
